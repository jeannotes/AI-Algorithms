...
EntryId Database::add(
    ...
    BowVector *bowvec, FeatureVector *fvec) {// std::map<NodeId, std::vector<unsigned int> >
...
EntryId Database::add(const BowVector &v,
    ...
    for (vit = v.begin(); vit != v.end(); ++vit) {
         ...
         * so when sompare the score, only need to compare the same node, we have those images's weight
