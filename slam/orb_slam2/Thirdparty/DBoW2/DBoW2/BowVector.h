...
EXPORT typedef enum LNorm { L1, L2 } LNorm;

/// Weighting type
EXPORT typedef enum WeightingType { TF_IDF, TF, IDF, BINARY } WeightingType;
...
class EXPORT BowVector : public std::map< WordId, WordValue > {
  public:
    /**
     * Constructor
     */
