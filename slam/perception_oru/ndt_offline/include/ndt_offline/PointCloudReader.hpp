...
class PointCloudBagReader : public BagRangeReaderInterface< sensor_msgs::PointCloud2,
  ...
  public:
    ...
    */
    PointCloudBagReader( std::string calibration_file, std::string bagfilename,
                         ...
                         double min_laser_range = 0.5, bool use_odo = true,
                         bool use_sensor_pose = true )
        : BagRangeReaderInterface< sensor_msgs::PointCloud2, sensor_msgs::PointCloud2::ConstPtr >(
