...
perception_oru::particle::particle( double roll, double pitch, double yaw, double x, double y,
                                    double z ) {
...
void perception_oru::particle::Set( double roll, double pitch, double yaw, double x, double y,
                                    double z ) {
    // r_=roll;
    // p_=pitch;
    // t_=yaw;
