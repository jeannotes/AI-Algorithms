...
#include "ros/ros.h"
perception_oru::particle_filter_HMT::particle_filter_HMT(
    perception_oru::NDTMapHMT* ndtMap_, int particleCount_ /*, init_type initializationType_*/,
...
void perception_oru::particle_filter_HMT::InitializeNormal( double x, double y, double th,
                                                            double var ) {
...
void perception_oru::particle_filter_HMT::GetPoseMeanAndVariance2D( Eigen::Vector3d& mean,
                                                                    Eigen::Matrix3d& cov ) {
    double sumX = 0, sumY = 0;
    double sumW = 0;
    double ax = 0, ay = 0;
...
void perception_oru::particle_filter_HMT::UpdateAndPredict( Eigen::Affine3d tMotion,
...
void perception_oru::particle_filter_HMT::UpdateAndPredictEff(
    ...
    Eigen::Vector3d rot = tMotion.rotation().eulerAngles( 0, 1, 2 );
    if ( tr[0] != 0.0 && tr[1] != 0.0 && rot[2] != 0 ) {
        Predict2D( tr[0], tr[1], rot[2], tr[0] * 0.05 + 0.005, tr[1] * 0.05 + 0.005,
                   rot[2] * 0.05 + 0.001 );
...
void perception_oru::particle_filter_HMT::Predict2D( double x, double y, double th, double sx,
...
void perception_oru::particle_filter_HMT::GetRandomPoint( perception_oru::NDTCell* cell, double& x,
                                                          double& y, double& th ) {
...
void perception_oru::particle_filter_HMT::EigenSort( Eigen::Vector3d& eigenvalues,
