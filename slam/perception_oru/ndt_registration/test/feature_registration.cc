...
int main( int argc, char** argv ) {
    ...
    *cloudF = lslgeneric::readVRML( argv[2] );
    ...
    std::cout << "FPFH\n";
    std::cout << "E translation " << Tout.translation().transpose() << " (norm) "
              << Tout.translation().norm() << std::endl;
    std::cout << "E rotation " << Tout.rotation().eulerAngles( 0, 1, 2 ).transpose() << " (norm) "
              << Tout.rotation().eulerAngles( 0, 1, 2 ).norm() << std::endl;
    std::cout << " TIME: "
              << ( tv_end1.tv_sec - tv_start.tv_sec ) * 1000. +
                     ( tv_end1.tv_usec - tv_start.tv_usec ) / 1000.
              << std::endl;
    ...
    std::cout << "E rotation " << Tout.rotation().eulerAngles( 0, 1, 2 ).transpose() << " (norm) "
              << Tout.rotation().eulerAngles( 0, 1, 2 ).norm() << std::endl;
    std::cout << " TIME: "
              << ( tv_end2.tv_sec - tv_start.tv_sec ) * 1000. +
                     ( tv_end2.tv_usec - tv_start.tv_usec ) / 1000.
              << std::endl;
