...
int main( int argc, char** argv ) {
    ...
    desc.add_options()( "help",
                        "produce help message" )( "file-name", po::value< string >( &base_name ),
                                                  "location of the ndt map you want to view" )(
        ...
        "robot_height", po::value< double >( &robot_height )->default_value( 1.86 ), "robvot "
                                                                                     "height" );
