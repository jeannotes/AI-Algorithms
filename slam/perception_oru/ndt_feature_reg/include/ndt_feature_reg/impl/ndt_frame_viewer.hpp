...
/*
template <typename PointT>
NDTFrameViewer<PointT>::NDTFrameViewer(NDTFrame<PointT> *f0, NDTFrame<PointT> *f1,
NDTFrameProc<PointT> &proc) : _proc(proc)
{
...
template < typename PointT >
void NDTFrameViewer< PointT >::initViewer() {
...
template < typename PointT >
void NDTFrameViewer< PointT >::showNDT() {}

template < typename PointT >
void NDTFrameViewer< PointT >::showMatches( const std::vector< std::pair< int, int > >& matches ) {
...
template < typename PointT >
void NDTFrameViewer< PointT >::showMatches( const std::vector< cv::DMatch >& matches ) {
...
template < typename PointT >
bool NDTFrameViewer< PointT >::wasStopped() {
    return _viewer->wasStopped();
}

template < typename PointT >
void NDTFrameViewer< PointT >::spinOnce() {
