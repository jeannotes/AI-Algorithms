...
class NDTDLRegTypeParam : public registrationParameters {
  ...
  protected:
    NDTDLRegTypeParam();   // Constructor is protected to allow only graphcatory to instanciate or
...
class NDTDLRegType : public registrationType {
  public:
    ...
    bool Register( MapTypePtr maptype, Eigen::Affine3d& Tnow, pcl::PointCloud< PointT >& cloud,
