...
class MapType {
  public:
     ...
     * scan was taken from(scanner) in the world fram
     * \param Tnow transformation from world to sensor frame
     * \param cloud data to update map with
     */
    virtual bool Initialized() const { return initialized_; }
    virtual void update( const Eigen::Affine3d& Tnow, pcl::PointCloud< pcl::PointXYZ >& cloud,
                         bool simple = false ) = 0;
    ...
    virtual bool CompoundMapsByRadius( MapTypePtr target, const Affine3d& T_source,
                                       const Affine3d& T_target, double radius = 5 );
