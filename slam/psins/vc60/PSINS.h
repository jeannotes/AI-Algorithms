...
class CGLV {
  public:
    ...
    CGLV( double Re = 6378137.0, double f = ( 1.0 / 298.257 ), double wie0 = 7.2921151467e-5,
...
class CVect3 {
  public:
    ...
    CVect3( CMat3& Cnb );   //  {i=asinEx(Cnb.e21), j=atan2Ex(-Cnb.e20, Cnb.e22),
                            //  k=atan2Ex(-Cnb.e01, Cnb.e11);}; // m2att
    ...
    friend double dot( CVect3 v1, CVect3& v2 ) {
...
class CMat3 {
  public:
    ...
    CMat3( void ){};
    CMat3( double xx, double xy, double xz, double yx, double yy, double yz, double zx, double zy,
           double zz ) {
    ...
    CMat3 operator*( double f ) {
        return CMat3( e00 * f, e01 * f, e02 * f, e10 * f, e11 * f, e12 * f, e21 * f, e20 * f,
                      e22 * f );
    };
    friend CMat3 operator*( double f, CMat3& m ) {
        return CMat3( m.e00 * f, m.e01 * f, m.e02 * f, m.e10 * f, m.e11 * f, m.e12 * f, m.e20 * f,
                      m.e21 * f, m.e22 * f );
    };
    CVect3 operator*( CVect3& v ) {
...
class CEarth {
  public:
    ...
    CVect3 vn2dpos( CVect3& vn, double ts = 1.0 ) {
...
class CSINS {
  public:
    ...
    void etm( CMat3& Maa, CMat3& Mav, CMat3& Map, CMat3& Mva, CMat3& Mvv, CMat3& Mvp, CMat3& Mpv,
              CMat3& Mpp );
};
