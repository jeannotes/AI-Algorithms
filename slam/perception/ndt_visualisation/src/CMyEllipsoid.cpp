...
void CMyEllipsoid::render_dl() const {
    ...
    MRPT_END_WITH_CLEAN_UP( cout << "Covariance matrix leading to error is:" << endl
                                 << m_cov << endl; );
#endif
}
...
bool CMyEllipsoid::traceRay( const mrpt::poses::CPose3D& o, double& dist ) const {
    ...
    lin.unitarize();   // By adding this line, distance from any point of the line to its base is
                       // exactly equal to the "t".
