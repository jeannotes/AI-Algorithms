...
class NDTDLMapType : public MapType {
  public:
    ...
    virtual void update( const Eigen::Affine3d& Tsensor, pcl::PointCloud< pcl::PointXYZ >& cloud,
                         bool simple = false );   // Mandatory, base method implemented as pure
                                                  // virtual
    ...
    virtual bool CompoundMapsByRadius( MapTypePtr target, const Affine3d& T_source,
                                       const Affine3d& T_target, double radius );   // Optional
  ...
  protected:
    ...
    void InitializeMap( const Eigen::Affine3d& Tsensor, pcl::PointCloud< pcl::PointXYZ >& cloudFlat,
