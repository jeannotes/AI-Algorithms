...
void parseLogFile( std::string filename, pcl::PointCloud< pcl::PointXYZ >& pcloud ) {
    ...
    pcloud.points.clear();
    while ( fscanf( fin, "%lf,%f,%f,%f,%lf,%d,%d", &t, &pt.x, &pt.y, &pt.z, &in, &ids, &idp ) >
            0 ) {
...
int main( int argc, char** argv ) {
    ...
    desc.add_options()( "help", "produce help message" )(
        "base-name", po::value< string >( &base_name ), "pre-string of the files to be loaded, "
        ...
        "resolution of the map for ndt fuser" );
