...
int main( int argc, char** argv ) {
    if ( argc < 22 ) {
        std::cout << "usage " << argv[0] << " cloud_fixed.pcd cloud_offset.pcd T00 T01 T02 T03 T10 "
                                            "T11 T12 T13 T20 T21 T22 T23 T30 T31 T32 T33 "
                                            "max_resolution n_iterations subsample_size\n";
        return -1;
    }
    ...
    std::cout << tend - tnow << ", " << m( 0, 0 ) << ", " << m( 0, 1 ) << ", " << m( 0, 2 ) << ", "
              << m( 0, 3 ) << ", " << m( 1, 0 ) << ", " << m( 1, 1 ) << ", " << m( 1, 2 ) << ", "
              << m( 1, 3 ) << ", " << m( 2, 0 ) << ", " << m( 2, 1 ) << ", " << m( 2, 2 ) << ", "
              << m( 2, 3 ) << ", " << m( 3, 0 ) << ", " << m( 3, 1 ) << ", " << m( 3, 2 ) << ", "
              << m( 3, 3 ) << std::endl;
