...
Eigen::MatrixXd computeHessianMahalanobis( const Eigen::MatrixXd& Q ) {
    ...
    H << Q( 0, 0 ) + Q( 0, 0 ), Q( 1, 0 ) + Q( 0, 1 ), Q( 2, 0 ) + Q( 0, 2 ), Q( 3, 0 ) + Q( 0, 3 ),
        Q( 4, 0 ) + Q( 0, 4 ), Q( 5, 0 ) + Q( 0, 5 ), Q( 0, 1 ) + Q( 1, 0 ), Q( 1, 1 ) + Q( 1, 1 ),
        Q( 2, 1 ) + Q( 1, 2 ), Q( 3, 1 ) + Q( 1, 3 ), Q( 4, 1 ) + Q( 1, 4 ), Q( 5, 1 ) + Q( 1, 5 ),
        Q( 0, 2 ) + Q( 2, 0 ), Q( 1, 2 ) + Q( 2, 1 ), Q( 2, 2 ) + Q( 2, 2 ), Q( 3, 2 ) + Q( 2, 3 ),
        Q( 4, 2 ) + Q( 2, 4 ), Q( 5, 2 ) + Q( 2, 5 ), Q( 0, 3 ) + Q( 3, 0 ), Q( 1, 3 ) + Q( 3, 1 ),
        Q( 2, 3 ) + Q( 3, 2 ), Q( 3, 3 ) + Q( 3, 3 ), Q( 4, 3 ) + Q( 3, 4 ), Q( 5, 3 ) + Q( 3, 5 ),
        Q( 0, 4 ) + Q( 4, 0 ), Q( 1, 4 ) + Q( 4, 1 ), Q( 2, 4 ) + Q( 4, 2 ), Q( 3, 4 ) + Q( 4, 3 ),
        Q( 4, 4 ) + Q( 4, 4 ), Q( 5, 4 ) + Q( 4, 5 ), Q( 0, 5 ) + Q( 5, 0 ), Q( 1, 5 ) + Q( 5, 1 ),
        Q( 2, 5 ) + Q( 5, 2 ), Q( 3, 5 ) + Q( 5, 3 ), Q( 4, 5 ) + Q( 5, 4 ), Q( 5, 5 ) + Q( 5, 5 );
...
double NDTMatcherD2DSC::lineSearchMTSC(
    Eigen::Matrix< double, 6, 1 >& increment, std::vector< NDTCell* >& sourceNDT, NDTMap& targetNDT,
    ...
    while ( 1 ) {
        ...
        Eigen::Affine3d T_current  = ps * T;   // Note that ps is not an incremental part, it is
                                               // redefined in each loop from frame T.
...
void NDTMatcherD2DSC::scoreComparision( NDTMap& targetNDT, NDTMap& sourceNDT,
                                        const Eigen::Affine3d& T, const Eigen::MatrixXd& Tcov,
                                        double& score_NDT, double& score_NDT_SC,
                                        const Eigen::Affine3d& offset,
                                        const Eigen::Affine3d& odom_offset, double alpha ) {
...
bool NDTMatcherD2DSC::match( NDTMap& targetNDT, NDTMap& sourceNDT,
    ...
    while ( !convergence ) {
        ...
        if ( score_here < score_best ) {
            ...
            if ( iter > 1 ) {
                ...
                std::cerr << "[" << iter << "] X : " << X.transpose() << " -- " << score_here
                          << std::endl;
            }
        } else {
        ...
        //        std::cerr << " score_here : " << score_here << " score_gradient : " <<
        //        score_gradient.transpose() << std::endl;
