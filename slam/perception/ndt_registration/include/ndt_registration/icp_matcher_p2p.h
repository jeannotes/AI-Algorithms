...
void calculate_ICP_COV(pcl::PointCloud<pcl::PointXYZ>& data_pi, pcl::PointCloud<pcl::PointXYZ>& model_qi, Eigen::Matrix4d& transform, Eigen::MatrixXd& ICP_COV) {
...
public:
    ...
    const pcl::PointCloud<pcl::PointXYZ>& getFinalPC() const {
        return final_;
    }
