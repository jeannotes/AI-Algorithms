...
int main( int argc, char** argv ) {
    ...
    perception_oru::NDTFuserHMT ndtslammer(
        resolution, size_xy, size_xy, size_z, sensor_cutoff, visualize, match2d, use_multires,
        fuse_incomplete, itrs, base_name, beHMT, map_dirname, step_control, do_soft_constraints,
        nb_neighbours, resolution_local_factor );
    //     ros::Time::init();
    ...
    for ( int i = 0; i < scanfiles.size(); i++ ) {
        ...
        perception_oru::ndt_offline::LaserBagReader< pcl::PointXYZ > vreader(
            ...
            &sensor_link, sensor_time_offset );
