...
// 					global_scan = m.instantiate<velodyne_msgs::VelodyneScan>();
    ...
    sensorMsgTypeCst getLastMsg() {
        return global_scan;
    }
    const sensorMsgTypeCst& getLastMsg() const {
        return global_scan;
    }
...
// 				exit(0);
    ...
    Eigen::Affine3d& getMotion() {
        return motion_;
    }
    const Eigen::Affine3d& getMotion() const {
        return motion_;
    }
    Eigen::Affine3d& getLastPose() {
        return _last_pose;
    }
    const Eigen::Affine3d& getLastPose() const {
        return _last_pose;
    }
    Eigen::Affine3d& getBaseLinkPose() {
        return _baselink_pose;
    }
