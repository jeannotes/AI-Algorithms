...
void NDTFrameViewer::initViewer() {
...
void NDTFrameViewer::showFeaturePC() {
...
void NDTFrameViewer::showNDT() {}

void NDTFrameViewer::showMatches( const std::vector< std::pair< int, int > >& matches ) {
...
void NDTFrameViewer::showMatches( const std::vector< cv::DMatch >& matches ) {
    std::vector< std::pair< int, int > > tmp;
    _proc->convertMatches( matches, tmp );
    this->showMatches( tmp );
}

bool NDTFrameViewer::wasStopped() {
    return _viewer->wasStopped();
}

void NDTFrameViewer::spinOnce() {
