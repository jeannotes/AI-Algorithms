...
void NDTFrameProc< PointT >::addFrameIncremental( NDTFrame< PointT >* f, bool skipMatching,
                                                  bool ndtEstimateDI, bool match_full,
...
template < typename PointT >
void NDTFrameProc< PointT >::processFrames( bool skipMatching, bool ndtEstimateDI, bool match_full,
                                            bool match_no_association ) {
...
template < typename PointT >
void NDTFrameProc< PointT >::detectKeypoints( NDTFrame< PointT >* f ) const {
    if ( img_scale == 1. ) {
...
template < typename PointT >
void NDTFrameProc< PointT >::calcDescriptors( NDTFrame< PointT >* f ) const {
    if ( img_scale == 1. ) {
