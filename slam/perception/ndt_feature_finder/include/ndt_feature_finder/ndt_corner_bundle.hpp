...
public:
    ...
    {}
    void push_back_cell1(const boost::shared_ptr< perception_oru::NDTCell >& c1) {
        _cell1.push_back(c1);
    }
    void push_back_cell2(const boost::shared_ptr< perception_oru::NDTCell >& c2) {
        _cell2.push_back(c2);
    }
    ...
    void setAngles(const std::vector<double>& a) {
        _angle = a;
    }
    void setOrientations(const std::vector<double>& d) {
        _orientation = d;
    }
    ...
    const Eigen::Matrix3d& getEigenVectors() const {
        return _eigen_vector;
    }
    const Eigen::Vector3d& getEigenValues() const {
        return _eigen_values;
    }
    Eigen::Matrix3d getEigenVectors() {
        return _eigen_vector;
    }
    Eigen::Vector3d getEigenValues() {
        return _eigen_values;
    }
    const std::vector<double>& getOrientations() const {
        return _orientation;
    }
    const std::vector<double>& getAngles() const {
        return _angle;
    }
    std::vector<boost::shared_ptr< perception_oru::NDTCell > >& getCells1() {
        return _cell1;
    }
    const std::vector<boost::shared_ptr< perception_oru::NDTCell > >& getCells1() const {
        return _cell1;
    }
    std::vector<boost::shared_ptr< perception_oru::NDTCell > >& getCells2() {
        return _cell2;
    }
    const std::vector<boost::shared_ptr< perception_oru::NDTCell > >& getCells2() const {
        return _cell2;
    }
