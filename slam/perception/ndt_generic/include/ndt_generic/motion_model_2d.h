...
/*!
  ...
  This relative incremental pose can then directly be used to get the incremental motion (need to
  adjust it with the current heading), and to get the covariance of the motion.
*/
  ...
  public:
    ...
    class Params {
      public:
        ...
        /*!
         * Same notation/params as in Eliazar, Learning Probabilistic Motion Models for Mobile
         * Robots.
         */
        Params() {
            Cd = 0.001;
    ...
    void setParams( const MotionModel2d::Params& p ) { params = p; }
    ...
    Eigen::MatrixXd getCovMatrix6( const Eigen::Affine3d& rel, double varZ, double varRoll,
                                   double varPitch ) const {
