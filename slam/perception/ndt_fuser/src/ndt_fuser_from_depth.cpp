...
int main( int argc, char** argv ) {
    ...
    desc.add_options()( "help", "produce help message" )( "debug", "print debug output" )(
        "visualize", "visualize the output" )( "init-gt", "use the first pose of gt as the start "
                                                          "pose of the transform track" )(
        "association", po::value< string >( &association_name ), "association file name (generated "
                                                                 "by association.py script)" )(
        ...
        "resolution", po::value< double >( &resolution )->default_value( 0.1 ), "iresolution of "
                                                                                "the ndt model" )(
    ...
    if ( vm.count( "init-gt" ) ) {
        ...
        cerr << "using init pose of " << dx << " " << dy << " " << dz << " " << qx << " " << qy
             << " " << qz << " " << qw << endl;
    ...
    for ( size_t i = 0; i < associations.size(); i++ ) {
        ...
        depth_img = cv::imread( associations[i].second,
                                CV_LOAD_IMAGE_ANYDEPTH );   // CV_LOAD_IMAGE_ANYDEPTH is important
