...
class tfMessageReader {
  public:
    /**
    * Open @bagfilename, subscribe to topic @message_topic_ use tf target_linkname_, which is fixed
    *to fixed_link_
    **/
    tfMessageReader( std::string bagfilename, std::string message_topic_, std::string fixed_link_,
