...
class NDTMCL {
  public:
     ...
     * Constructor
     */
    NDTMCL( double map_resolution, perception_oru::NDTMap& nd_map, double zfilter )
     ...
     *
     */
    void initializeFilter( double x, double y, double yaw, double x_e, double y_e, double yaw_e,
                           int numParticles ) {
        pf.initializeNormalRandom( mcl::pose( x, y, yaw ), mcl::pose( x_e, y_e, yaw_e ),
                                   numParticles );
    }
