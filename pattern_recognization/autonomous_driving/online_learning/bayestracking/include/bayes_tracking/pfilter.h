...
class PFilter : public SIR_kalman_scheme {
  public:
     ...
     * @return
     */
    PFilter( std::size_t x_size, std::size_t s_size, SIR_random& random_helper );
     ...
     */
    PFilter( std::size_t x_size, std::size_t s_size = 1000 );
     ...
     * @param random_helper Random generator
     */
    PFilter( const FM::Vec& x0, const FM::SymMatrix& P0, std::size_t s_size,
     ...
     * @param s_size Number of samples (default 1000)
     */
    PFilter( const FM::Vec& x0, const FM::SymMatrix& P0, std::size_t s_size = 1000 );
    ...
    /**
      ...
      */
    void observe( Likelihood_observe_model& observe_model, const FM::Vec& z );
