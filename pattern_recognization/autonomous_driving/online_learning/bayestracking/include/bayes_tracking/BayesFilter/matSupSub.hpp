 ...
 *
 * Gappy matrix support: The macros BAYES_FILTER_(SPARSE/COMPRESSED/COORDINATE) control experimental
 * gappy matrix support
...
#if defined( BAYES_FILTER_MAPPED ) || defined( BAYES_FILTER_COMPRESSED ) || \
    defined( BAYES_FILTER_COORDINATE )
...
typedef ublas::mapped_matrix< Float, ublas::row_major, std::map< std::size_t, Float > >
    BaseSparseRowMatrix;
typedef ublas::mapped_matrix< Float, ublas::column_major, std::map< std::size_t, Float > >
    BaseSparseColMatrix;
// OR Compressed types
 ...
 */
#include "bayes_tracking/BayesFilter/uBLASmatrix.hpp"
