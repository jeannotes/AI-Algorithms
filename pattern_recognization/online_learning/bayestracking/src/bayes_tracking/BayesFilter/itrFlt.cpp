 ...
 */
#include "bayes_tracking/BayesFilter/itrFlt.hpp"
...
Iterated_covariance_scheme& Iterated_covariance_scheme::
operator=( const Iterated_covariance_scheme& a )
...
Bayes_base::Float Iterated_covariance_scheme::predict( Linrz_predict_model& f ) {
...
Bayes_base::Float Iterated_covariance_scheme::observe( Linrz_uncorrelated_observe_model& h,
                                                       Iterated_terminator& term, const FM::Vec& z )
...
Bayes_base::Float Iterated_covariance_scheme::observe( Linrz_correlated_observe_model& h,
                                                       Iterated_terminator& term, const FM::Vec& z )
/* Iterated Extended Kalman Filter
 * Bar-Shalom and Fortmann p.119 (full scheme)
 * A hard limit is placed on the iterations whatever the
