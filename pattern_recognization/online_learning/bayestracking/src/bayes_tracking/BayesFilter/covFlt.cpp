...
Bayes_base::Float Covariance_scheme::predict( Gaussian_predict_model& f )
...
Bayes_base::Float Covariance_scheme::observe_innovation( Linrz_correlated_observe_model& h,
                                                         const FM::Vec& s )
...
Bayes_base::Float Covariance_scheme::observe_innovation( Linrz_uncorrelated_observe_model& h,
                                                         const FM::Vec& s )
