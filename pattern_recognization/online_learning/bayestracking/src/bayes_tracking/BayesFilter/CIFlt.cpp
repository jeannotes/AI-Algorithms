 ...
 * TODO: Implement useful Omega based on iterative optimization algorithm from the authors of
 * reference [1]
 */
#include "bayes_tracking/BayesFilter/CIFlt.hpp"
...
Bayes_base::Float CI_scheme::predict( Linrz_predict_model& f ) {
...
Bayes_base::Float CI_scheme::observe_innovation( Linrz_uncorrelated_observe_model& h,
                                                 const FM::Vec& s )
...
Bayes_base::Float CI_scheme::observe_innovation( Linrz_correlated_observe_model& h,
                                                 const FM::Vec& s )
