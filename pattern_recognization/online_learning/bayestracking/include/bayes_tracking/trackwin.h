...
class TrackWin {
  public:
    ...
    */
    TrackWin( const char* name, int width = WINDOW_WIDTH, int height = WINDOW_HEIGHT,
    ...
    */
    void setObject( const char* label, double xpos, double ypos,
                    double orientation = NO_ORIENTATION, color_t color = BLACK, double varx = 0,
                    double vary = 0, double covxy = 0, const ColMatrix* samples = NULL );
