...
class Boost_random : public SIR_random, public Bayesian_filter_test::Boost_random {
  public:
    ...
    void normal( DenseVec& v ) { Bayesian_filter_test::Boost_random::normal( v ); }
    using Bayesian_filter_test::Boost_random::uniform_01;
    void uniform_01( DenseVec& v ) { Bayesian_filter_test::Boost_random::uniform_01( v ); }
};
 ...
 */
class CVModel : public JacobianModel, public Linrz_predict_model, public Sampled_predict_model {
  public:
...
class CartesianModel : public JacobianModel,
                       public Linrz_correlated_observe_model,
...
class CVModel3D : public JacobianModel, public Linrz_predict_model, public Sampled_predict_model {
  public:
    /** Size of the human state */
