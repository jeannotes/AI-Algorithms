...
int writePPMImage( char* filename, unsigned char* image, int height, int width, int depth,
                   char* comments ) {
...
int writePGMImage( char* filename, unsigned char* image, int height, int width, int depth,
                   char* comments ) {
    if ( !filename || !image ) return PPM_NULL_PTR;
    FILE* fp = fopen( filename, "wb" );
    if ( !fp ) return PPM_FILE_ERROR;
...
// write a PNM image
int writePNMImage( char* filename, unsigned char* image, int height, int width, int depth,
                   bool color, char* comments ) {
    int error;
    if ( color ) {
...
int readPPMImage( char* filename, unsigned char** image, int& height, int& width, int& depth ) {
    ...
    //!-Start modification by Sushil Mittal for handling different kinds of formats of .ppm file,
    //! 05/05/2009
    char buf[70];
    ...
    //!-End modification by Sushil Mittal for handling different kinds of formats of .ppm file,
    //! 05/05/2009
    //********************************************************
...
// read a PNM image
int readPNMImage( char* filename, unsigned char** image, int& height, int& width, int& depth,
                  bool& color ) {
