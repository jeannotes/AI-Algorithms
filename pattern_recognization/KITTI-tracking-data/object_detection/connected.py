...
class Connected:
    ...
    def __init__(self, input_matrix):
        ...
        # matrix which holds the output
        self.direction = np.zeros((self.row, self.col))
    ...
    # loca is a list consisting of the row and column 
    # of the location for which 8-neighborhood has to be calculated.
    ...
    # Function to calculate the component locations and
    # label them differently to distinguish them.
    def connected_components(self):
        for r in range(self.row):
            for c in range(self.col):
                if self.direction[r, c] == 0 and self.input_matrix[r, c] == 1:
                    # generating new label when we come across a new component
                    ...
                    # Looping to find out all the elements in a component.
                    while(len(self.neighbors_queue) > 0):
    ...
    # connected_components function has already been called
    #  to get the number of components found
    def number_components(self):
        return self.label

    # This function can be called from a connected object after
    # connected_components function has already been called to
    #  refine the number of components found
