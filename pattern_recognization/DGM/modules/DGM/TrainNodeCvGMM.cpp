...
// Constructor
CTrainNodeCvGMM::CTrainNodeCvGMM( byte nStates, word nFeatures, TrainNodeCvGMMParams params )
...
// Constructor
CTrainNodeCvGMM::CTrainNodeCvGMM( byte nStates, word nFeatures, size_t maxSamples, byte numGausses )
    : CBaseRandomModel( nStates )
    , CTrainNode( nStates, nFeatures )
    , m_minCoefficient( 1 ) {
