...
{
// Constructor
CTrainNodeCvKNN::CTrainNodeCvKNN( byte nStates, word nFeatures, TrainNodeCvKNNParams params )
...
// Constructor
CTrainNodeCvKNN::CTrainNodeCvKNN( byte nStates, word nFeatures, size_t maxSamples )
    : CBaseRandomModel( nStates )
    , CTrainNode( nStates, nFeatures ) {
