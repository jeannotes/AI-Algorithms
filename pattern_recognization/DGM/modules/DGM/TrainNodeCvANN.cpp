...
{
// Constructor
CTrainNodeCvANN::CTrainNodeCvANN( byte nStates, word nFeatures, TrainNodeCvANNParams params )
...
// Constructor
CTrainNodeCvANN::CTrainNodeCvANN( byte nStates, word nFeatures, size_t maxSamples )
    : CBaseRandomModel( nStates )
    , CTrainNode( nStates, nFeatures ) {
