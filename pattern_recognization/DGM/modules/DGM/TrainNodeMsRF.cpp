...
{
// Constructor
CTrainNodeMsRF::CTrainNodeMsRF( byte nStates, word nFeatures, TrainNodeMsRFParams params )
...
// Constructor
CTrainNodeMsRF::CTrainNodeMsRF( byte nStates, word nFeatures, size_t maxSamples )
    : CBaseRandomModel( nStates )
    , CTrainNode( nStates, nFeatures ) {
