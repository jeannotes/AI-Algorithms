...
{
// Constructor
CTrainNodeCvSVM::CTrainNodeCvSVM( byte nStates, word nFeatures, TrainNodeCvSVMParams params )
...
// Constructor
CTrainNodeCvSVM::CTrainNodeCvSVM( byte nStates, word nFeatures, size_t maxSamples )
    : CBaseRandomModel( nStates )
    , CTrainNode( nStates, nFeatures ) {
