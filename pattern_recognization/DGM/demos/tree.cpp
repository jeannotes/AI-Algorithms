...
Mat CTree::getEdgePot( void ) {
    ...
    res.at< float >( 0, 0 ) = 0.9890f;
    res.at< float >( 0, 1 ) = 0.0099f;
    res.at< float >( 0, 2 ) = 0.0010f;
    res.at< float >( 0, 3 ) = 0.0001f;
    res.at< float >( 1, 0 ) = 0.1309f;
    res.at< float >( 1, 1 ) = 0.8618f;
    res.at< float >( 1, 2 ) = 0.0066f;
    res.at< float >( 1, 3 ) = 0.0007f;
    res.at< float >( 2, 0 ) = 0.0420f;
    res.at< float >( 2, 1 ) = 0.0841f;
    res.at< float >( 2, 2 ) = 0.8682f;
    res.at< float >( 2, 3 ) = 0.0057f;
    res.at< float >( 3, 0 ) = 0.0667f;
    res.at< float >( 3, 1 ) = 0.0333f;
    res.at< float >( 3, 2 ) = 0.1667f;
    res.at< float >( 3, 3 ) = 0.7333f;
    return res;
}
