...
int main( int argc, char* argv[] ) {
    ...
    float vInitParam[4]  = { 100.0f, 10.0f, 100.0f, 10.0f };
    float vInitDeltas[4] = { 10.0f, 1.0f, 10.0f, 1.0f };
