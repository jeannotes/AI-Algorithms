...
#endif
#else
#define GLM_HAS_CXX11_STL ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC48 ) ) || \
...
#else
#define GLM_HAS_STATIC_ASSERT ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC43 ) ) || \
...
#define GLM_HAS_CONSTEXPR_PARTIAL GLM_HAS_CONSTEXPR
#else
#define GLM_HAS_CONSTEXPR ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC48 ) ) ) )   // GCC 4.6 support constexpr but there is a compiler bug causing a crash
...
#else
#define GLM_HAS_INITIALIZER_LISTS ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC44 ) ) || \
                                                                            ( ( GLM_COMPILER & GLM_COMPILER_VC ) && ( GLM_COMPILER >= GLM_COMPILER_VC2013 ) ) || \
...
#else
#define GLM_HAS_UNRESTRICTED_UNIONS ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_VC ) && ( GLM_LANG & GLM_LANG_CXXMS_FLAG ) ) ||        \
                                                                            ( ( GLM_COMPILER & GLM_COMPILER_CUDA ) && ( GLM_COMPILER >= GLM_COMPILER_CUDA75 ) ) || \
...
#else
#define GLM_HAS_DEFAULTED_FUNCTIONS ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC44 ) ) ||     \
                                                                              ( ( GLM_COMPILER & GLM_COMPILER_VC ) && ( GLM_COMPILER >= GLM_COMPILER_VC2013 ) ) ||     \
...
#else
#define GLM_HAS_RVALUE_REFERENCES ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC43 ) ) || \
...
#else
#define GLM_HAS_EXPLICIT_CONVERSION_OPERATORS ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC45 ) ) ||     \
...
#else
#define GLM_HAS_TEMPLATE_ALIASES ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_INTEL ) && ( GLM_COMPILER >= GLM_COMPILER_INTEL12_1 ) ) || \
...
#else
#define GLM_HAS_RANGE_FOR ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC46 ) ) ||     \
...
#else
#define GLM_HAS_ASSIGNABLE ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_GCC ) && ( GLM_COMPILER >= GLM_COMPILER_GCC49 ) ) ) )
#endif
...
#else
#define GLM_HAS_MAKE_SIGNED ( ( GLM_LANG & GLM_LANG_CXX0X_FLAG ) && ( ( ( GLM_COMPILER & GLM_COMPILER_VC ) && ( GLM_COMPILER >= GLM_COMPILER_VC2013 ) ) || \
                                                                      ( ( GLM_COMPILER & GLM_COMPILER_CUDA ) && ( GLM_COMPILER >= GLM_COMPILER_CUDA50 ) ) ) )
#endif
...
#else
#define GLM_HAS_BITSCAN_WINDOWS ( ( GLM_PLATFORM & GLM_PLATFORM_WINDOWS ) && ( ( GLM_COMPILER & ( GLM_COMPILER_VC | GLM_COMPILER_INTEL ) ) ) )
#endif
