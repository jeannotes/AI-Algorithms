...
class ParallelTreeTrainingOperation {
  private:
    ...
    class ThreadLocalData {
      public:
        ...
        ThreadLocalData( Random& random, ITrainingContext< F, S >& trainingContext_, const TrainingParameters& parameters, IDataPointCollection const& data )
            : random_( random.Next() ) {
            maxGain           = 0.0;
            bestThreshold     = 0.0;
